          ...
          <center><Col key={index} md={9}>
            <div className={`timeline-item ${index % 2 === 0? 'left' : 'right'}`}>
              <div className="timeline-item-content bg-black rounded-3 shadow py-3 my-2 mb-4 mx-2 px-3" data-aos="zoom-in" data-aos-duration="1500" data-aos-easing="ease-in-out">
                ...
                <p className='par fs-5 px-1'>{experience.description4}</p>
                <p className='par fs-5 px-1'>{experience.description5}</p>
                <p className='par fs-5 px-1'>{experience.description6}</p>
                <p className='par fs-5 px-1'>{experience.description7}</p>
